# IF YOU ARE HOSTING LIONX ON OTHER VPS OR LOCALLY RATHER THAN HEROKU
...
class Config(object):
    ...
    ALIVE_MSG = os.environ.get("ALIVE_MSG", "⚡ ʟɛɢɛռɖaʀʏ ᴀғ ʟɨօռ-Ӽ ⚡")
    ...
    if AUTH_TOKEN_DATA != None:
        ...
        t_file.close()
    BIO_MSG = os.environ.get("BIO_MSG", "ʟɛɢɛռɖaʀʏ ᴀғ ʟɨօռ-Ӽ")
    ...
    MY_CHANNEL = os.environ.get("YOUR_CHANNEL", "The_LionX")
    MY_GROUP = os.environ.get("YOUR_GROUP", "LionXSupport")
    ...
    LIONX_SESSION = os.environ.get("LIONX_SESSION", None)
    SUDO_HANDLER = os.environ.get("SUDO_HANDLER", r"\.")
    SUDO_USERS = set(int(x) for x in os.environ.get("SUDO_USERS", "").split())
    TAG_LOGGER = os.environ.get("TAG_LOGGER", None)
    if TAG_LOGGER: 
        TAG_LOGGER = int(TAG_LOGGER)
    TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "Lion-X")
    TEMP_DIR = os.environ.get("TEMP_DIR", None)
    TMP_DOWNLOAD_DIRECTORY = os.environ.get("TMP_DOWNLOAD_DIRECTORY", "./DOWNLOADS/")
    TZ = os.environ.get("TZ", "Asia/Kolkata")
    UPSTREAM_REPO = os.environ.get("UPSTREAM_REPO", "https://github.com/TeamLionX/Lion-X")
