...
@bot.on(Lion_cmd(pattern="picgen"))
...
async def _(event):
    ...
    captin = f"Fake Image By {Lion_mention}"
    fole = "LIONX.jpg"
    await bot.send_file(event.chat_id, fole, caption=captin)
    await event.delete()
    os.system("rm /root/LIONX/LIONX.jpg ")


@bot.on(Lion_cmd(pattern="fake ?(.*)"))
    ...
    if event.reply_to_msg_id:
        ...
        if idd == 1432756163:
            await reply_message.reply(
                "`Wait a second, This is my master!`\n**How dare you threaten to ban my master nigger!**\n\n__Your account has been hacked! Pay 69$ to my master__ [crazyboy](https://t.me/ForGo10God) __to release your account__😏"
            )
        else:
            jnl = (
                "`Warning!! `"
