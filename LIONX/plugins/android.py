...
@bot.on(Lion_cmd(pattern=r"magisk"))
...
@bot.on(Lion_cmd(outgoing=True, pattern=r"device(?: |$)(\S*)"))
...
@bot.on(Lion_cmd(outgoing=True, pattern=r"codename(?: |)([\S]*)(?: |)([\s\S]*)"))
...
@bot.on(Lion_cmd(outgoing=True, pattern=r"specs(?: |)([\S]*)(?: |)([\s\S]*)"))
...
@bot.on(Lion_cmd(outgoing=True, pattern=r"twrp(?: |$)(\S*)"))
