...
@bot.on(Lion_cmd(outgoing=True, pattern="carbon(?: |$)(.*)"))
...
async def carbon_api(e):
    ...
    Lion = await edit_or_reply(e, "`Carbonizing...\n25%`")
    ...
    await Lion.edit("`Processing..\n75%`")
    # Waiting for downloading
    await asyncio.sleep(2)
    await Lion.edit("`Done Dana Done...\n100%`")
    file = "./carbon.png"
    await Lion.edit("`Uploading..`")
    await e.client.send_file(
        e.chat_id,
        file,
        caption="Here's your carbon, \n Carbonised by ʟɨօռ-Ӽ",
        force_document=True,
...
@bot.on(Lion_cmd(outgoing=True, pattern="krb"))
@bot.on(sudo_cmd(pattern="krb", allow_sudo=True))
async def carbon_api(e):
    if e.fwd_from:
        return
    Lion = await edit_or_reply(e, "`Processing....`")
    CARBON = "https://carbon.now.sh/?l={lang}&code={code}"
    textx = await e.get_reply_message()
    pcode = e.text
    if pcode[5:]:
...
@bot.on(Lion_cmd(pattern=f"kar1(?: |$)(.*)", outgoing=True))
@bot.on(sudo_cmd(pattern="kar1(?: |$)(.*)", allow_sudo=True))
async def carbon_api(e):
    if e.fwd_from:
        return
    """ A Wrapper for carbon.now.sh """
    Lion = await edit_or_reply(e, "🔲🔲🔲🔲🔲")
    ...
    await Lion.edit("🔳🔳🔳🔳🔳")
    file = "./carbon.png"
    await Lion.edit("☣️Karbon1 Completed, Uploading Karbon☣️")
    await e.client.send_file(
        e.chat_id,
        file,
        force_document=True,
    ...
    os.remove("./carbon.png")
    # Removing carbon.png after uploading
    await Lion.delete()  # Deleting msg


@bot.on(Lion_cmd(pattern=f"kar2(?: |$)(.*)", outgoing=True))
...
async def carbon_api(e):
    ...
    await Lion.edit("🔘🔘🔘🔘🔘")
    file = "./carbon.png"
    await Lion.edit("☣️Karbon2 Completed, Uploading Karbon☣️")
    await e.client.send_file(
        e.chat_id,
        file,
...
@bot.on(Lion_cmd(pattern=f"kar3(?: |$)(.*)", outgoing=True))
...
async def carbon_api(e):
    ...
    await Lion.edit("🔵🔵🔵🔵🔵")
    file = "./carbon.png"
    await Lion.edit("☣️Karbon3 Completed, Uploading Karbon⬆️")
    await e.client.send_file(
        e.chat_id,
        file,
...
@bot.on(Lion_cmd(pattern=f"kar4(?: |$)(.*)", outgoing=True))
...
async def carbon_api(e):
    ...
    await Lion.edit("🌝🌝🌝🌝🌝")
    file = "./carbon.png"
    await Lion.edit("✅Karbon4 Completed, Uploading Karbon✅")
    await e.client.send_file(
        e.chat_id,
        file,
...
@bot.on(Lion_cmd(pattern=f"rgbk2(?: |$)(.*)", outgoing=True))
...
async def carbon_api(e):
    ...
    await Lion.edit("⬛⬛⬛⬛⬛")
    file = "./carbon.png"
    await Lion.edit("✅RGB Karbon 2.0 Completed, Uploading Karbon✅")
    await e.client.send_file(
        e.chat_id,
        file,
...
@bot.on(Lion_cmd(pattern=f"kargb(?: |$)(.*)", outgoing=True))
...
async def carbon_api(e):
    ...
    await Lion.edit("⬛⬛⬛⬛⬛")
    file = "./carbon.png"
    await Lion.edit("✅RGB Karbon Completed, Uploading Karbon✅")
    await e.client.send_file(
        e.chat_id,
        file,
        caption=f"Here's your karbonrgb",
