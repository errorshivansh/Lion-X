...
from LIONX.sql.welcome_sql import get_current_welcome, add_welcome, rm_welcome, update_welcome
from . import *
...
@bot.on(Lion_cmd(pattern="savewelcome(?: |$)(.*)"))
...
@bot.on(Lion_cmd(pattern="cleanwelcome$"))
...
@bot.on(Lion_cmd(pattern="showwelcome$"))
...
@bot.on(Lion_cmd(pattern="welcome_note$"))
