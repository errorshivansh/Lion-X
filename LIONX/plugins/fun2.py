...
@bot.on(Lion_cmd(pattern="pat ?(.*)", outgoing=True))
...
@bot.on(Lion_cmd(pattern="join$", outgoing=True))
...
@bot.on(Lion_cmd(pattern="pay$", outgoing=True))
...
@bot.on(Lion_cmd(pattern="climb$", outgoing=True))
...
@bot.on(Lion_cmd(pattern="aag$", outgoing=True))
...
@bot.on(Lion_cmd(pattern="push$", outgoing=True))
...
@bot.on(Lion_cmd(pattern="work$", outgoing=True))
...
@bot.on(Lion_cmd(pattern="suckit$", outgoing=True))
...
@bot.on(Lion_cmd(pattern="ohh$", outgoing=True))
...
@bot.on(Lion_cmd(pattern="lovestory$", outgoing=True))
...
@bot.on(Lion_cmd(pattern="bf$", outgoing=True))
...
@bot.on(Lion_cmd(pattern="session$", outgoing=True))
