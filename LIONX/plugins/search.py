...
@bot.on(Lion_cmd(pattern="ytube (.*)", outgoing=True))
...
@bot.on(Lion_cmd(pattern="ddg (.*)", outgoing=True))
...
@bot.on(Lion_cmd(pattern="altn (.*)", outgoing=True))
...
@bot.on(Lion_cmd(pattern="var (.*)", outgoing=True))
...
@bot.on(Lion_cmd(pattern="lmlog (.*)", outgoing=True))
...
@bot.on(Lion_cmd(pattern="hacc (.*)", outgoing=True))
...
@bot.on(Lion_cmd(pattern="lmkp (.*)", outgoing=True))
...
@bot.on(Lion_cmd(pattern="gem (.*)", outgoing=True))
...
@bot.on(Lion_cmd(pattern="rchiv (.*)", outgoing=True))
