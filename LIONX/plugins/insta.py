...
async def _(event):
    ...
    if "www.instagram.com" not in input_str:
        ...
        crazy = await eor(event, "Trying to download.... please wait!")
    async with event.client.conversation(bot) as conv:
        try:
            ...
            await crazy.edit("User Blocked!! Please Unblock @instasavegrambot and try again...")
            return
        await crazy.delete()
        ...
        await final.edit(
            f"📥 InstaGram Video Downloaded By :- {Lion_mention}")
