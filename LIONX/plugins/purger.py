...
@bot.on(Lion_cmd(pattern=r"purge", outgoing=True))
...
@bot.on(Lion_cmd(pattern=r"purgeme", outgoing=True))
...
@bot.on(Lion_cmd(pattern=r"sd", outgoing=True))
