...
from . import *
from LIONX.sql.filter_sql import get_filter, add_filter, remove_filter, get_all_filters, remove_all_filters
...
@bot.on(Lion_cmd(pattern=r"filter (.*)"))
...
@bot.on(Lion_cmd(pattern="filters$"))
...
@bot.on(Lion_cmd(pattern="rmallfilters$"))
