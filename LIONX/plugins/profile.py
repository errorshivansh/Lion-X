...
@bot.on(Lion_cmd(pattern="offline$", outgoing=True)) 
async def _(event):
    if event.fwd_from:
        return
    user_it = "me"
...
@bot.on(Lion_cmd(pattern="online$", outgoing=True))
async def _(event):
    if event.fwd_from:
        return
    user_it = "me"
...
@bot.on(Lion_cmd(outgoing=True, pattern="username (.*)"))
...
@bot.on(Lion_cmd(outgoing=True, pattern="count$"))
...
@bot.on(Lion_cmd(outgoing=True, pattern=r"delpfp"))
...
@bot.on(Lion_cmd(pattern="myusernames$"))
async def _(event):
    if event.fwd_from:
        return
