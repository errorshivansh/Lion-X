...
@bot.on(Lion_cmd(pattern="ls ?(.*)", outgoing=True))
...
@bot.on(Lion_cmd(pattern="ls_local$", outgoing=True))
...
async def _(event):
    ...
    OUTPUT = f"**Files in [ʟɨօռ-Ӽ]({chnl_link}) DOWNLOADS Folder:**\n"
...
@bot.on(Lion_cmd(pattern="ls_root$", outgoing=True))
...
@bot.on(Lion_cmd(pattern="ls_saved$", outgoing=True))
...
@bot.on(Lion_cmd(pattern="rnsaved ?(.*)", outgoing=True))
...
@bot.on(Lion_cmd(pattern="rnlocal ?(.*)", outgoing=True))
...
@bot.on(Lion_cmd(pattern="delsave (.*)", outgoing=True))
...
@bot.on(Lion_cmd(pattern="delocal (.*)", outgoing=True))
...
CmdHelp("managers").add_command(
  "ls_local", None, "Gives the list of downloaded medias in your LIONX server."
).add_command(
  "ls_root", None, "Gives the list of all files in root directory of LIONX repo."
).add_command(
  "ls_saved", None, "Gives the list of all files in Saved directory of your LIONX server"
).add_command(
