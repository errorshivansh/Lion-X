...
@bot.on(Lion_cmd(pattern="carry (.*)"))
@bot.on(sudo_cmd(pattern="carry (.*)", allow_sudo=True))
async def crazy(carry):
    if carry.fwd_from:
        return
...
@bot.on(Lion_cmd(pattern="sthink (.*)"))
@bot.on(sudo_cmd(pattern="sthink (.*)", allow_sudo=True))
async def crazy(think):
    if think.fwd_from:
        return
...
@bot.on(Lion_cmd(pattern="sfrog (.*)"))
@bot.on(sudo_cmd(pattern="sfrog (.*)", allow_sudo=True))
async def crazy(frogsay):
    if frogsay.fwd_from:
        return
...
@bot.on(Lion_cmd(pattern="sdead (.*)"))
@bot.on(sudo_cmd(pattern="sdead (.*)", allow_sudo=True))
async def crazy(deadfrog):
...
@bot.on(Lion_cmd(pattern="strump (.*)"))
@bot.on(sudo_cmd(pattern="strump (.*)", allow_sudo=True))
async def crazy(trumpsay):
...
@bot.on(Lion_cmd(pattern="schina (.*)"))
@bot.on(sudo_cmd(pattern="schina (.*)", allow_sudo=True))
async def crazy(ckmkb):
    if ckmkb.fwd_from:
        return
...
@bot.on(Lion_cmd(pattern=r"sshit$"))
@bot.on(sudo_cmd(pattern="sshit$", allow_sudo=True))
async def crazy(shit):
    if shit.fwd_from:
        return
    await edit_or_reply(shit, A)


@bot.on(Lion_cmd(pattern=r"elove$"))
...
@bot.on(Lion_cmd(pattern=r"monster$"))
...
@bot.on(Lion_cmd(pattern=r"hello$"))
...
@bot.on(Lion_cmd(pattern=r"couple$"))
...
@bot.on(Lion_cmd(pattern=r"india$"))
...
@bot.on(Lion_cmd(pattern=r"shitos$"))
...
@bot.on(Lion_cmd(pattern=r"dislike$"))
