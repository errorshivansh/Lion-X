...
@bot.on(Lion_cmd(pattern="frybot$"))
...
@bot.on(Lion_cmd(pattern=r"fry(?: |$)(.*)", outgoing=True))
...
async def deepfry(img: Image) -> Image:
    ...
    # Overlay red and yellow onto main image and sharpen the Lion out of it
