...
@bot.on(Lion_cmd(pattern=f"love$", outgoing=True))
...
@bot.on(Lion_cmd(pattern=f"dhoka$", outgoing=True))
...
@bot.on(Lion_cmd(pattern=f"metoo$", outgoing=True))
...
@bot.on(Lion_cmd(pattern=f"gdnoon$", outgoing=True))
...
@bot.on(Lion_cmd(pattern=f"chase$", outgoing=True))
@bot.on(sudo_cmd(pattern=f"chase$", allow_sudo=True))
async def police(e):
    txt = random.choice(CHASE_STR)
    await eor(e, txt)

@bot.on(Lion_cmd(pattern=f"congo$", outgoing=True))
...
@bot.on(Lion_cmd(pattern=f"qhi$", outgoing=True))
@bot.on(sudo_cmd(pattern=f"qhi$", allow_sudo=True))
async def hoi(e):
    txt = random.choice(HELLOSTR)
    await eor(e, txt)

@bot.on(Lion_cmd(pattern=f"gdbye$", outgoing=True))
...
@bot.on(Lion_cmd(pattern=f"gdnyt$", outgoing=True))
...
@bot.on(Lion_cmd(pattern=f"gdmng$", outgoing=True))
...
@bot.on(Lion_cmd(pattern="quote ?(.*)", outgoing=True))
...
async def quote_search(event):
    ...
    if response is not None:
        await Lion.edit(f"`{response['text']}`")
    else:
        await eod(Lion, "`Sorry Zero results found`")
