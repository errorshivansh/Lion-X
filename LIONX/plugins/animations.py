...
@bot.on(Lion_cmd(pattern=r"boxs$", outgoing=True))
...
@bot.on(Lion_cmd(pattern=r"rain$", outgoing=True))
...
@bot.on(Lion_cmd(pattern=r"deploy$", outgoing=True))
...
async def _(event):
    ...
    animation_chars = [
        "**Heroku Connecting To Latest [Github Build](TeamLionX/Lion-X)**",
        f"**Build started by user** {Lion_mention}",
        f"**Deploy** `535a74f0` **by user** **{Lion_mention}**",
        ...
        "__INFO:ʟɨօռ-Ӽ:Logged in as 557667062__",
        "__INFO:ʟɨօռ-Ӽ:Successfully loaded all plugins__",
        "**Build Succeeded**",
    ]
...
@bot.on(Lion_cmd(pattern=r"dump$", outgoing=True))
...
@bot.on(Lion_cmd(pattern=r"fleaveme$", outgoing=True))
...
@bot.on(Lion_cmd(pattern=r"loveu$", outgoing=True))
...
@bot.on(Lion_cmd(pattern=r"plane$", outgoing=True))
...
@bot.on(Lion_cmd(pattern=r"police$", outgoing=True))
...
@bot.on(Lion_cmd(pattern=f"hack$", outgoing=True))
...
@bot.on(Lion_cmd(pattern=r"jio$", outgoing=True))
...
@bot.on(Lion_cmd(pattern=r"solarsystem$", outgoing=True))
...
@bot.on(Lion_cmd(pattern=f"nehi$", outgoing=True))
...
@bot.on(Lion_cmd(pattern="phub$", outgoing=True))
...
@bot.on(Lion_cmd(pattern=r"amore$", outgoing=True))
...
@bot.on(Lion_cmd(pattern=r"sexy$", outgoing=True))
...
@bot.on(Lion_cmd(pattern="istar$", outgoing=True))
@bot.on(sudo_cmd(pattern="istar$", allow_sudo=True))
async def ammastar(Lionstar):
  
    if Lionstar.fwd_from:
    ...
    await eor(Lionstar, "I am A Star")
    ...
    for i in animation_ttl:
        ...
        await Lionstar.edit(animation_chars[i % 11])
    
        
@bot.on(Lion_cmd(pattern=r"lmoon", outgoing=True))
...
@bot.on(Lion_cmd(pattern=r"city", outgoing=True))
...
@bot.on(Lion_cmd(pattern=r"hii", outgoing=True))
...
@bot.on(Lion_cmd(pattern=r"cheer", outgoing=True))
...
@bot.on(Lion_cmd(pattern=r"getwell", outgoing=True))
...
@bot.on(Lion_cmd(pattern="switch$", outgoing=True))
...
async def _(event):
  ...
  #  if input_str == "switch":
    ...
    animation_chars = [
         "⬜⬜⬜⬜⬜⬜⬜\n⬜⬜⬜⬜⬜⬜⬜\n⬜⬜⬜⬜⬜⬜⬜\n⬜⬜⬜⬜⬜⬜[🔲](https://github.com/TeamLionX/Lion-X)\n⬜⬜⬜⬜⬜⬜⬜\n⬜⬜⬜⬜⬜⬜⬜\n⬜⬜⬜⬜⬜⬜⬜",
...
@bot.on(Lion_cmd(pattern=r"sprinkle", outgoing=True))
...
@bot.on(Lion_cmd(pattern=r"f", outgoing=True))
...
@bot.on(Lion_cmd(outgoing=True, pattern="kiler( (.*)|$)"))
...
async def _(event):
    ...
    event = await eor(event, f"**Ready Commando **__{Lion_mention}....")
    animation_chars = [
        "Ｆｉｉｉｉｉｒｅ",
        f"__**Commando **__{Lion_mention}          \n\n_/﹋\_\n (҂`_´)\n <,︻╦╤─ ҉ - \n _/﹋\_\n",
        f"__**Commando **__{Lion_mention}          \n\n_/﹋\_\n (҂`_´)\n  <,︻╦╤─ ҉ - -\n _/﹋\_\n",
        f"__**Commando **__{Lion_mention}          \n\n_/﹋\_\n (҂`_´)\n <,︻╦╤─ ҉ - - -\n _/﹋\_\n",
        f"__**Commando **__{Lion_mention}          \n\n_/﹋\_\n (҂`_´)\n<,︻╦╤─ ҉ - -\n _/﹋\_\n",
        f"__**Commando **__{Lion_mention}          \n\n_/﹋\_\n (҂`_´)\n <,︻╦╤─ ҉ - \n _/﹋\_\n",
...
@bot.on(Lion_cmd(pattern="thinking$"))
...
@bot.on(Lion_cmd(pattern=f"snake$", outgoing=True))
...
@bot.on(Lion_cmd(pattern=f"human$", outgoing=True))
...
@bot.on(Lion_cmd(pattern=f"mc$", outgoing=True))
...
@bot.on(Lion_cmd(pattern=r"repe$", outgoing=True))
...
@bot.on(Lion_cmd(pattern=f"nikal$", outgoing=True))
...
@bot.on(Lion_cmd(pattern=f"music$", outgoing=True))
...
@bot.on(Lion_cmd(pattern=f"squ$", outgoing=True))
