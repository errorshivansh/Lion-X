...
@bot.on(Lion_cmd(pattern="slap ?(.*)", outgoing=True))
...
async def slap(replied_user, event):
    ...
    caption = temp.format(
        user1=Lion_mention, user2=slapped, item=item, hits=hit, throws=throw
    )

    return caption

@bot.on(Lion_cmd(pattern=f"randi$", outgoing=True))
...
@bot.on(Lion_cmd(pattern=f"habuse$", outgoing=True))
...
@bot.on(Lion_cmd(pattern=f"fuk$", outgoing=True))
...
@bot.on(Lion_cmd(pattern=f"chu$", outgoing=True))
...
@bot.on(Lion_cmd(pattern=f"noob$", outgoing=True))
...
@bot.on(Lion_cmd(pattern=f"run$", outgoing=True))
...
@bot.on(Lion_cmd(pattern=f"gali$", outgoing=True))
...
@bot.on(Lion_cmd(pattern=f"rape$", outgoing=True))
...
@bot.on(Lion_cmd(pattern=f"abuse$", outgoing=True))
...
@bot.on(Lion_cmd(pattern=f"gey$", outgoing=True))
...
@bot.on(Lion_cmd(pattern=f"piro$", outgoing=True))
...
@bot.on(Lion_cmd(pattern="owo(?: |$)(.*)", outgoing=True))
