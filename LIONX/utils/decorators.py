...
from LIONX.sql import sudo_sql as s_ql

# admin cmd or normal user cmd
def Lion_cmd(pattern=None, command=None, **args):
    ...
    # blacklisted chats. 
    # LIONX will not respond in these chats.
